    ...
    <div>  
      ...
      <div className='splash-panels'>
        <div className='panels-top'>
          <div className='panel'>
            <h3 className='paneltitle'>Panel 1</h3>
            <p className='panelpara'>Maecenas pretium sem at tellus cursus ornare.</p>
          </div>
          <div className='panel'>
            <h3 className='paneltitle'>Panel 2</h3>
            <p className='panelpara'>Maecenas pretium sem at tellus cursus ornare.</p>
          </div>
        </div>
        <div className='panels-bottom'>
        <div className='panel'>
            <h3 className='paneltitle'>Panel 3</h3>
            <p className='panelpara'>Maecenas pretium sem at tellus cursus ornare.</p>
          </div>
          <div className='panel'>
            <h3 className='paneltitle'>Panel 4</h3>
            <p className='panelpara'>Maecenas pretium sem at tellus cursus ornare.</p>
          </div>
        </div>
